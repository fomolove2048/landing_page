        ...
        <div className={styles.faq_bg}>
            ...
            <div className={styles.faq_body}>
                ...
                <div className={styles.faq_right}>
                    ...
                    <div className={`${styles.answer} ${hide1?styles.hidden:''}`}><span className={styles.bold}>Total supply</span>: 9,000 NFTs, with four rarity tiers: Common, Rare, Legendary, Early Supporters.</div>
